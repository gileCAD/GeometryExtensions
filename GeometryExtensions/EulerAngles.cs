...
namespace Gile.AutoCAD.R19.Geometry
{
    ...
    public struct EulerAngles
    {
        ...
        public bool IsEqualTo(EulerAngles other) => IsEqualTo(other, Tolerance.Global);
        ...
        /// <returns><c>true</c>, if the two instance are equal ; <c>false</c>, otherwise.</returns>
        public bool IsEqualTo(EulerAngles other, Tolerance tolerance) => Transform.IsEqualTo(other.Transform, tolerance);
